 ...
 * Copyright:   	Copyright 2018 Johannes Neumeier
 */
...
require_once plugin_dir_path(__FILE__) . 'classes/Price_Bulk_Updater_Plugin.php';
require_once plugin_dir_path(__FILE__) . 'classes/Price_Bulk_Updater_Product_Search.php';
$updater = new Price_Bulk_Updater_Plugin();

register_activation_hook(__FILE__, array('Price_Bulk_Updater_Plugin', 'hook_activate'));
