 ...
 * Plugin URI:		https://wordpress.org/plugins/woocommerce-price-updater
 * Description:		A simple Wordpress WooCommerce plugin to set or replace WooCommerce prices in bulk
 * Version:     	0.1.0
 * WC Tested Up To: 3.2.6
 * Author:      	Underscore
 * Author URI:  	https://johannesneumeier.com
 * Copyright:   	Copyright 2018 Johannes 'kontur' Neumeier
 */
defined('ABSPATH') or die('Access denied.');

define('WOOCOMMERCE_PRICE_UPDATER_NAMESPACE', 'woocommerce-price-updater');
define('WOOCOMMERCE_PRICE_UPDATER_ADMIN_URL_NAME', 'woocommerce-price-updater');
